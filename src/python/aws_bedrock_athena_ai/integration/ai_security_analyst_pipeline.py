...
class AISecurityAnalystPipeline:
    ...
    def __init__(self, aws_region: str = "us-east-1"):
        ...
        try:
            ...
            # Initialize AWS clients for UsageTracker
            import boto3
            from types import SimpleNamespace
            aws_clients = SimpleNamespace(
            ...
            self.usage_tracker = UsageTracker(aws_clients)
        ...
        try:
            status = {
                ...
                "usage_stats": {
                    ...
                    "note": "Usage tracking available per service type"
                },
